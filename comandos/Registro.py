...
class Registro(commands.Cog):
    ...
    async def registrar(self, inter_comando : disnake.ApplicationCommandInteraction):
        ...
        embed_escolha = disnake.Embed(
            ...
            description="Existem duas formas de se registrar. Clique no botão para selecionar o método que gostaria de usar.",
                        ...
                        def __init__(self):
                            super().__init__(
                                ...
                                components=[
                                    ...
                                    disnake.ui.TextInput(label="ltuid da HoyoLab", style=disnake.TextInputStyle.short, placeholder="ltuid", custom_id="ltuid"),
                                    disnake.ui.TextInput(label="ltoken da HoyoLab", style=disnake.TextInputStyle.short, placeholder="ltoken", custom_id="ltoken")
                                    ]
                                )
